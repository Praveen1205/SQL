...
select * from icc_world_cup;    # Output
 |Team_1|Team_2|Winner|       | Team | Total_Match | Win | Loss |
 |India |  SL  | India|	      | India|      2      |  2  |  0   |
 |  SL  | Aus  | Aus  |       |   NZ |      1      |  1  |  0   |
 |  SA  | Eng  | Eng  |       |  Eng |      2      |  1  |  1   |
 |  Eng | NZ   | Aus  |       |  Aus |      2      |  1  |  1   |
 | Aus  |India |India |       |   SA |      1      |  0  |  1   |
                              |   SL |      2      |  0  |  2   |
Solution 1
with all_team as (
		Select Team_1, case when Team_1=Winner Then 1 else 0 end as no_of_wins 
		from icc_world_cup
	Union all
		Select Team_2, case when Team_2=Winner Then 1 else 0 end as no_of_wins 
		from icc_world_cup
		)
